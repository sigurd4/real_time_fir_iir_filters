...
moddef::moddef!(
    flat(pub) mod {
        ...
        first_order_butterworth for cfg(feature = "param_omega"),
        ...
        second_order_butterworth for cfg(feature = "param_omega"),
        ...
        third_order_butterworth for cfg(feature = "param_omega"),
