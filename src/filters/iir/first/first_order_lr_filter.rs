use crate::{calc::iir::first::FirstOrderLRCalc, conf::{All, HighPass, LowPass}, param::{FirstOrderLRFilterConf, FirstOrderLRFilterParam, LR}};
...
crate::def_rtf!(
    {
        ...
        /// 
        /// <div>
        /// <img alt="First order LR-filter response" src="https://raw.githubusercontent.com/sigurd4/real_time_fir_iir_filters/refs/heads/master/plots/first_order_l_r_filter.png" height="500">
        /// </div>
    }
    FirstOrderLRFilter
    {
...
mod test
{
    ...
    fn plot()
    {
        let mut filter = FirstOrderLRFilter::<All>::new(LR {l: 100e-3, r: 10e3});
