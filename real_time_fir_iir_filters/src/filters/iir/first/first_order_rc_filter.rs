...
use crate::{conf::{All, HighPass, LowPass}, param::{FirstOrderRCFilterConf, FirstOrderRCFilterParam}, params::RC, real_time_fir_iir_filters};
...
mod test
{
    ...
    fn plot()
    {
        let mut filter = FirstOrderRCFilter::new::<All>(RC::new(10000.0, 0.000000033));
